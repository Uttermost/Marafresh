...
public class MeatCategories extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meat_categories);
    ...
    public void onClick(View v) {
        if ( v == FreshFish ) {
            ...
            // Handle clicks for vegatableSeeds
            Intent xbrew = new Intent(getApplicationContext(), ShoppingActivity.class);
            xbrew.putExtra("subcategory","Beef");
            startActivity(xbrew);
        } else if ( v == Goat ) {
