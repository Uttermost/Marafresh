...
//
    ...
    private void filldata(){
        ...
        Intent i = getIntent();
        final String key=i.getExtras().getString("category");

        //Query queryReftwo = myFirebaseRef.child("REPORTS").orderByChild("VOTES").startAt("0");
        Query queryReftwo = mDatabase.child("Products").orderByChild("Category").equalTo(key);
        ...
        queryRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot snapshot, String s) {
                ...
                if (newPost != null) {
                    ...
                    //allReports.clear();
                    foodList.clear();
                    pDialog = new ProgressDialog(SelectedCategory.this);
                    pDialog.setMessage("Fetching data");
                    pDialog.show();
